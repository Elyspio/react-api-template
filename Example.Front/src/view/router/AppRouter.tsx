...
function RequireAuth({ children }: PropsWithChildren) {
	...
	}, [auth.isLoading, auth.activeNavigator, auth.isAuthenticated, location.pathname, location.search, location.hash, auth]);
...
function AuthCallback() {
	...
	useEffect(() => {
		...
		void navigate(getReturnToPath(auth.user?.state), { replace: true });
