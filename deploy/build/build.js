...
const dockerCommand = `docker buildx build --platform linux/amd64,linux/arm64  -f ${__dirname}/Dockerfile  -t elyspio/react-api-template:latest --push .`.split(" ").filter((str) => str.length);
